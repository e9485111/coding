...
class Solution:
    ...
    def calculate(self, s):
      ...
      st1 = []
      st2 = []
      v, i = self.get_int(s, i)
      st1.append(v)
      while i < len(s):
        op, i = self.get_op(s,i)
        if op is None:
          self.reduce(st1,st2)
          break
        elif op in ["+","-"]:
